...
#ifdef _AFX
  HICON hIcon = static_cast<HICON>(::LoadImage(AfxGetResourceHandle(), lpIconName, IMAGE_ICON, 16, 16, 0));
#else
  HICON hIcon = static_cast<HICON>(::LoadImage(ATL::_AtlBaseModule.GetResourceInstance(), lpIconName, IMAGE_ICON, 16, 16, 0));
#endif
  if (hIcon == NULL)
  {
  #ifdef _AFX
